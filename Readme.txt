...
2. Why there are manual copy data, crawl data, local cache 3 methods?
...
I use time.performance() to track the time each stage. The slowness is from stage 1, take about 41 seconds. Stage 2 is 0.3 seconds and stage 3 is instantly done.
